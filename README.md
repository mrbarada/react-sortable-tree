...
![NPM version](https://img.shields.io/npm/v/@mrbarada/react-sortable-tree.svg?style=flat)
![NPM license](https://img.shields.io/npm/l/@mrbarada/react-sortable-tree.svg?style=flat)
[![NPM total downloads](https://img.shields.io/npm/dt/@mrbarada/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@mrbarada/react-sortable-tree?minimal=true)
[![NPM monthly downloads](https://img.shields.io/npm/dm/@mrbarada/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@mrbarada/react-sortable-tree?minimal=true)
...
```sh
# NPM
npm install @mrbarada/react-sortable-tree --save

# YARN
yarn add @mrbarada/react-sortable-tree
```
...
import '@mrbarada/react-sortable-tree/style.css';

// You can import the default tree with dnd context
import SortableTree from '@mrbarada/react-sortable-tree';

// Or you can import the tree without the dnd context as a named export. eg
import { SortableTreeWithoutDndContext as SortableTree } from '@mrbarada/react-sortable-tree';

// Importing from cjs (default)
import SortableTree from '@mrbarada/react-sortable-tree/dist/index.cjs.js';
import SortableTree from '@mrbarada/react-sortable-tree';

// Importing from esm
import SortableTree from '@mrbarada/react-sortable-tree/dist/index.esm.js';
```
...
import SortableTree from '@mrbarada/react-sortable-tree';
import '@mrbarada/react-sortable-tree/style.css'; // This only needs to be imported once in your app
...
Check out the helper functions exported from [`tree-data-utils.js`](https://github.com/mrbarada/react-sortable-tree/blob/master/src/utils/tree-data-utils.js).
